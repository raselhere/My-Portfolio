...
export const projectsData: ProjectData[] = [
  ...
  },
  {
    ...
    description:
      "A Machine Learning approach to detect Bangla Sign Language. This project uses computer vision and machine learning techniques to recognize and interpret sign language gestures.",
  ...
  },
  {
    ...
    description:
      "Large-scale data applications in modern computing frameworks experience various memory deficiencies together with high computation times while using significant amounts of energy.",
    technologies: ["TypeScript", "Data Processing", "Optimization", "Framework", "Energy Efficiency"],
    github: "https://github.com/raselhere/Cost-Efficient-Computation-Framework-for-Data-Intensive-Applications",
    image: "/images/githubProject.png",
  },
  {
    title: "Need-A-Bus",
    description:
      "A transportation solution platform that connects users with bus services. This application helps users find and book bus services based on their requirements.",
    technologies: ["C", "Transportation", "Booking System", "User Interface"],
    github: "https://github.com/raselhere/Need-A-Bus",
    image: "/images/githubProject.png",
  },
  {
    title: "Jakat Management System",
    description:
